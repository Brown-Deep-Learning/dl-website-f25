...
const LandingPage = () => {
  ...
  const handleButtonClick = () => {
    if (drillRef.current) {
      drillRef.current.classList.add(styles.drilling);
      ...
      drillRef.current.addEventListener(
        "animationend",
        () => {
          if (drillRef.current) {
            drillRef.current.classList.remove(styles.drilling);
          }
        },
        { once: true }
      );
  ...
  return (
    <div ref={sectionRef} className={styles.container}>
      ...
      />
      <TypewriterText
        text="BROWN UNIVERSITY'S JOURNEY INTO DEEP EARTH"
        speed={150}
      ...
      <button
        ...
        aria-label="Begin your journey into the Earth"
      >
        <DrillIcon />
      </button>
    </div>
